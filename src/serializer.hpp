...
#define SERIALIZE_CLASS(args...) \
    ...
    auto deserialize(std::istream &is) { serializer::deserialize_fields(is, args); }
...
namespace serializer {
    ...
    namespace serializer_concepts {
        ...
        template <typename T> concept IterableContainer = requires(T& cont, T const& const_cont) {
        ...
        template<typename T> concept HasTwoIteratorConstructor = requires(typename T::iterator it) {
            T{it, it};
        };
        template<typename T> concept Container = Sizeable<T> && IterableContainer<T> && HasTwoIteratorConstructor<T>;
    } // namespace serializer_concepts
    ...
    void serialize_fields(std::ostream &os) {}
    ...
    void deserialize_fields(std::istream &is) {}
